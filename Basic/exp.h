 ...
 * Class: Expression
 * -----------------
 * This class is used to represent a node in an expression tree.(那tree用什么存？)
 ...
 *  2. IdentifierExp -- a string representing an identifier//operator算不算identifier?//应该不算，identifier 应该是变量名
